  ...
  return (
    ...
    <>
      ...
      <div className="w-full h-screen duration-500" style={{backgroundColor: bgColor}}>
        <div className="flex flex-wrap justify-center bottom-12 insert-x-0 px-2 items-center">
          <div className="flex flex-wrap justify-center gap-3 bg-gray-300 p-3 rounded-full">
            ...
            <button className="rounded-md bg-yellow-400 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-black/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
